...
class InterfazGrafica:
    def __init__(self, ecosistema):
        ...
        self.meteorito_image = pygame.image.load("meteorito.jpg")
        self.meteorito_image = pygame.transform.scale(self.meteorito_image, (50, 50))
        self.meteorito_timer = pygame.time.get_ticks() 
        self.meteorito_delay = 5000  # o el valor que desees, en milisegundos
    ...
    def dibujar_meteorito(self):
        if self.meteorito_visible:
            # Dibuja el meteorito en una posición específica (puedes ajustar esto)
            self.screen.blit(self.meteorito_image, (300, 300))
    ...
    def ejecutar_interfaz(self):
        while True:
            ...
            self.actualizar_meteorito()  # Llama al método para actualizar el meteorito
            self.dibujar_meteorito()
            pygame.display.flip()
